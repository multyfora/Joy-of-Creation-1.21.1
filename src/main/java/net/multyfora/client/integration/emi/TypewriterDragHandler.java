...
public class TypewriterDragHandler implements EmiDragDropHandler<PortableTypewriterScreen> {

    @Override
    public boolean dropStack(PortableTypewriterScreen screen, EmiIngredient ingredient, int mouseX, int mouseY) {
        for (int i = 0; i < 2; i++) {
